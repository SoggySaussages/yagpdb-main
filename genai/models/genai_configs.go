...
type (
	...
	// This should generally be used opposed to []GenaiConfig.
...
// CountG returns the count of all GenaiConfig records in the query, and panics on error.
...
func GenaiConfigs(mods ...qm.QueryMod) genaiConfigQuery {
	...
	return genaiConfigQuery{NewQuery(mods...)}
}
