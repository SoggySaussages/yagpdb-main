...
func createInteractiveHelp(userID int64, helpEmbeds []*discordgo.MessageEmbed) (interface{}, error) {
	...
	if err != nil {
		return "Something went wrong, maybe you have DMs disabled? I don't want to spam this channel so here's a external link to available commands: <https://help.sgpdb.xyz/docs/core/all-commands/>", err
	}
...
For more in depth help and information you should visit https://help.sgpdb.xyz/ as this command only shows information about commands.)
