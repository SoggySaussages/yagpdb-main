...
import (
	...
	"github.com/SoggySaussages/sgpdb/logs/models"
...
var cmdLogs = &commands.YAGCommand{
	...
	Arguments: []*dcmd.ArgDef{
		{Name: "Count", Default: 100, Type: &dcmd.IntArg{Min: 2, Max: 1000}},
	},
...
var confEnableUsernameTracking = config.RegisterOption("sgpdb.enable_username_tracking", "Enable username tracking", true)
